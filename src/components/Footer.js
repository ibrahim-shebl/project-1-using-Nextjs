    ...
    <div className="w-full bg-darkText text-slate-100">
      <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="flex flex-col gap-y-4">
          <Logo />
          <p>
          On an online shopping site, you can shop for whatever you want at any time.
          </p>
          <div className="flex items-center gap-x-4">
            <a href="https://github.com/ibrahim-shebl" target="_blank">
              <span className="socialLink">
                <BsGithub />
              </span>
            </a>
            <a href="https://www.linkedin.com/in/ebrahim-shebl-0ab761276/" target="_blank">
              <span className="socialLink">
                <BsLinkedin />
              </span>
            </a>
            <a href="https://www.facebook.com/?ref=homescreenpwa" target="_blank">
              <span className="socialLink">
                <BsFacebook />
              </span>
            </a>
